# Clap-switch-project-using-lm358-555
This project implements a sound-activated switch using analog electronics. A microphone detects sound, an LM358 comparator processes the signal, and a 555 timer activates an LED for a fixed duration.This project implements a sound-activated switch using analog electronics. 
...
<br>
<br>
<img width="1536" height="1024" alt="7bec33f0-a633-45e3-b653-cdd1fd7261f0" src="https://github.com/user-attachments/assets/975e97b8-f4ce-4e56-8de5-c0b7bb7875e2" />
...
Note
At first, I was unaware that the microphone had specific polarity (positive and negative terminals).
This led to damaging the initial microphone.
Later, I used a multimeter to correctly determine the polarity before reconnecting the new one.
